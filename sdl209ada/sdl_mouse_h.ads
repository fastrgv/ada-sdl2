...
package SDL_mouse_h is
  ...
  --*< Hand  
   ...
   with Convention => C;  -- ../inc209/SDL_mouse.h:61
  ...
  --*< The scroll direction is flipped / natural  
   ...
   with Convention => C;  -- ../inc209/SDL_mouse.h:70
  ...
  --  
   ...
   function SDL_GetMouseFocus return access SDL_video_h.SDL_Window  -- ../inc209/SDL_mouse.h:77
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetMouseState (x : access int; y : access int) return SDL_stdinc_h.Uint32  -- ../inc209/SDL_mouse.h:87
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetGlobalMouseState (x : access int; y : access int) return SDL_stdinc_h.Uint32  -- ../inc209/SDL_mouse.h:112
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetRelativeMouseState (x : access int; y : access int) return SDL_stdinc_h.Uint32  -- ../inc209/SDL_mouse.h:121
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_WarpMouseInWindow
     (window : access SDL_video_h.SDL_Window;
      x : int;
      y : int)  -- ../inc209/SDL_mouse.h:132
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_WarpMouseGlobal (x : int; y : int) return int  -- ../inc209/SDL_mouse.h:144
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_SetRelativeMouseMode (enabled : SDL_stdinc_h.SDL_bool) return int  -- ../inc209/SDL_mouse.h:162
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CaptureMouse (enabled : SDL_stdinc_h.SDL_bool) return int  -- ../inc209/SDL_mouse.h:193
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetRelativeMouseMode return SDL_stdinc_h.SDL_bool  -- ../inc209/SDL_mouse.h:200
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateCursor
     (data : access SDL_stdinc_h.Uint8;
      ...
      h : int;
      hot_x : int;
      hot_y : int) return access SDL_Cursor  -- ../inc209/SDL_mouse.h:220
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateColorCursor
     (surface : access SDL_surface_h.SDL_Surface;
      hot_x : int;
      hot_y : int) return access SDL_Cursor  -- ../inc209/SDL_mouse.h:230
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateSystemCursor (id : SDL_SystemCursor) return access SDL_Cursor  -- ../inc209/SDL_mouse.h:239
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_SetCursor (cursor : access SDL_Cursor)  -- ../inc209/SDL_mouse.h:244
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCursor return access SDL_Cursor  -- ../inc209/SDL_mouse.h:249
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetDefaultCursor return access SDL_Cursor  -- ../inc209/SDL_mouse.h:254
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_FreeCursor (cursor : access SDL_Cursor)  -- ../inc209/SDL_mouse.h:263
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_ShowCursor (toggle : int) return int  -- ../inc209/SDL_mouse.h:273
   with Import => True, 
        Convention => C, 
