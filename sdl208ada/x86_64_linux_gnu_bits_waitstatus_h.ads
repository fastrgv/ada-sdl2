  ...
  -- Macros for constructing status values.   
   ...
   type wait (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            uu_wait_terminated : aliased anon_19;  -- /usr/include/x86_64-linux-gnu/bits/waitstatus.h:83
         when others =>
            uu_wait_stopped : aliased anon_20;  -- /usr/include/x86_64-linux-gnu/bits/waitstatus.h:96
      end case;
   end record;
